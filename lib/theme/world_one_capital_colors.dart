...
class WorldOneCapitalColors {
  ...
  // 🎨 Primary / Brand
  static const Color primary = Color(0xFF253378);
  static const Color primaryDark = Color(0xFF253378);
  static const Color secondary = Color(0xFF60AED9);
